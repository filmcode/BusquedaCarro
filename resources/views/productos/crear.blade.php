            ...
            @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <input name="intercambio" style="border-color: rgb(37 99 235);" class="py-2 px-3 rounded-lg border-2 mt-1 focus:outline-none focus:ring-2" type="text" />
                    </div>
                    <div class="grid grid-cols-1">  
                ...
                <label class="uppercase md:text-sm text-xs text-black-500 text-light font-semibold mb-1">Subir evidencias (Recibo caja, pedido, preautorizacion de credito):</label>
                    <div class='flex items-center justify-center w-full'>
                        <label style="border-color: rgb(37 99 235);" class='flex flex-col border-4 border-dashed w-full h-32 hover:bg-blue-100 hover:border-blue-300 group'>
                            ...
                            <p class='text-sm text-blue-400 group-hover:text-blue-600 pt-1 tracking-wider'>Seleccione la imagen</p>
                            </div>
